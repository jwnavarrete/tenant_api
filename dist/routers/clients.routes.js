...
const clientsContoller = __importStar(require("@/controllers/clients.controller"));
...
exports.clientsRoutes.post("/register/", 
//   validateTokenJwtMiddleware,
//   validateNewsIdMiddleware,
(0, validateBody_middleware_1.validateBodyMiddleware)(clients_schemas_1.ClientCreateSchema), clientsContoller.createClientsController);
