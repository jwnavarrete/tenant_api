...
class AuthMailService {
    static sendWelcomeEmail(to, name) {
        return __awaiter(this, void 0, void 0, function* () {
            const html = (0, templateRenderer_1.default)("auth/welcome", { name });
            const mailOptions = {
    ...
    static sendVerificationEmail(to, link) {
        return __awaiter(this, void 0, void 0, function* () {
            const html = (0, templateRenderer_1.default)("auth/verify-email", { link });
            const mailOptions = {
                from: process.env.SMTP_USER,
                to,
