...
exports.retrieveProfileUserService = void 0;
const server_1 = require("@/server");
const errors_1 = require("@/errors");
const users_schemas_1 = require("@/schemas/users.schemas");
const logics = __importStar(require("./logics"));
const retrieveProfileUserService = (userIdParams) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const responseUserProfileSerializer = users_schemas_1.UserReturnCreatedSchema.parse(findUser);
    return responseUserProfileSerializer;
});
exports.retrieveProfileUserService = retrieveProfileUserService;
