...
const validateQuery_middleware_1 = require("@/middlewares/global/validateQuery.middleware");
...
exports.tenantRoutes.get("/", validateTokenJwt_middlewares_1.validateTokenJwtMiddleware, (0, validateQuery_middleware_1.validateQueryMiddleware)(tenant_schemas_1.QuerySchema), tenantController.getAllTenant);
